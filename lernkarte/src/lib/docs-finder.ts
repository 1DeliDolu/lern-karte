...
export function findDocNodeBySegments(nodes: DocNode[], segments: string[]): DocNode | null {
...
export function listDocChildrenBySegments(nodes: DocNode[], segments: string[]): DocNode[] {
